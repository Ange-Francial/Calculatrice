...
{      
    ...
    //gtk_table_attach_defaults(GTK_TABLE(table), entrer, 0, 4, 5, 6);

    // g_signal_connect(GTK_OBJECT(bouton[0]),"clicked", G_CALLBACK(addition),NULL);

    //gtk_container_set_border_width(GTK_CONTAINER(window), 100);
//    gtk_container_add(GTK_CONTAINER(window), vbox );
    /* Ajout des boutons  */
/*    gtk_box_pack_start (GTK_BOX(vbox), entrer, TRUE, FALSE, 0);
    gtk_box_pack_start(GTK_BOX(vbox), hbox, TRUE, TRUE, 0);
    // Puis on met les Widgets dans la GtkVBox:
  
    gtk_box_pack_start (GTK_BOX(hbox), bouton[0], TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[1], TRUE, FALSE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[2], TRUE, FALSE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[3], TRUE, FALSE, 0);

    
    gtk_box_pack_start (GTK_BOX(vbox), bouton[4], TRUE, FALSE, 0);

    gtk_box_pack_start(GTK_BOX(vbox), hbox, TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[5], TRUE, FALSE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[6], TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[7], TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[8], TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[9], TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[10], TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[11], TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[12], TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[13], TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[14], TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[15], TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[16], TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[17], TRUE, TRUE, 0);
    gtk_box_pack_start (GTK_BOX(hbox), bouton[18], TRUE, TRUE, 0);

*/
    // gtk_container_set_border_width(GTK_CONTAINER(window), 100);
  
    // button[0] = gtk_button_new_with_label("pgcd");
    // button[1] = gtk_button_new_with_label("ppcm");
    // button[2] = gtk_button_new_with_label("+");
  
    //g_signal_connect(GTK_OBJECT(button[0]), "clicked", G_CALLBACK(addition), "button[0]]");
